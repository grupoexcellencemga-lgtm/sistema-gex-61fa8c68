...
const ROLE_DEFAULTS: Record<string, PageKey[]> = {
  ...
  comercial: ["dashboard", "alunos", "jornada", "produtos", "turmas", "eventos", "vendedores", "metas", "aniversarios", "tarefas", "checklist", "configuracoes", "divulgacao"],
  financeiro: ["dashboard", "financeiro", "relatorios", "aniversarios", "tarefas", "checklist", "configuracoes", "divulgacao"],
  suporte: ["dashboard", "alunos", "turmas", "eventos", "aniversarios", "tarefas", "checklist", "configuracoes", "divulgacao"],
  profissional: ["dashboard", "processo-individual", "processo-empresarial", "turmas", "eventos", "aniversarios", "tarefas", "checklist", "configuracoes", "divulgacao"],
};
