...
export function TurmaUTMLinksDialog({ open, onOpenChange, turma }: Props) {
  const [copied, setCopied] = useState<string | null>(null);

  const base = `${window.location.origin}/inscricao-turma/${turma.id}`;
  const campaign = slugify(turma.nome || "turma");
