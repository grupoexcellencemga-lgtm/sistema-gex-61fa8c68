import { 
  ...
  DollarSign, BarChart3, Shield, Settings, ChevronLeft, ChevronRight, Route, LogOut, UserCheck, Award, Building2, Cake, Brain, Target, ClipboardList, CheckSquare, Sun, Moon, Monitor, Megaphone, ListChecks
} from "lucide-react";
...
const menuGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Checklist", url: "/checklist", icon: ListChecks, pageKey: "checklist" as PageKey },
