                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      <div>
                        ...
                        <select name="conta_bancaria_id" className="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm" defaultValue={editingDespesa?.conta_bancaria_id || ""} disabled={contasFetching}>
                          <option value="">{contasFetching ? "Carregando contas..." : "Selecione"}</option>
